...
var ip1;
  ...
  ip1 = FileHelper.readStringFromFileAtPath
  	(
  		pathOfFileToRead
  	);
  }
...
{ 
    ...
    xmlHttp.open("GET","http://"+ip1+":8080/WebRTC_presentation/FriendListController?action=findFriendURI&friendName="+frinedtobeadded, true);     
    xmlHttp.send(); 
...
{ 
   ...
   // alert("frind to be removed : "+frinedtoberemoved );
    xmlHttp.open("GET","http://"+ip1+":8080/WebRTC_presentation/FriendListController?action=removefriend&friendName="+frinedtoberemoved, true);     
    xmlHttp.send(); 
    setTimeout(function(){compressCode();},700);
}
</script>
