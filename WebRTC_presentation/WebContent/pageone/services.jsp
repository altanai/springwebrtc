...
<div class="containsection" >
             <div class="row no-bottom-margin">
                ...
                <section class="col"  >
                    <h2><a href="conferencing12.jsp" target=newtab> Conferencing </a></h2>
                ...
                <section class="col mid">
                    <h2><a href="../../UploadPicsAudioVideo/CreateUserServlet?action=getUser&id=<%=session.getAttribute("privateIdentity")%>&name=<%=session.getAttribute("name")%>" >Profile</a></h2>
