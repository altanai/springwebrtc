...
<head>
    ...
    -->
<!-- 
 <script src="<c:url value="resources/scripts/SIPml-api.js?svn=179"/>" type="text/javascript"> </script>
 -->
 ...
 <!-- Styles -->
 <!--
  <link href="src="<c:url value="resources/assets/css/bootstrap.css"/>" rel="stylesheet" />
  -->
  <link href="src="<c:url value="resources/release/assets/css/bootstrap.css"/>" rel="stylesheet" />
    ...
    <link href="<c:url value="resources/release/assets/css/bootstrap-responsive.css"/>" rel="stylesheet" />
    <!-- Le fav and touch icons -->
    <link rel="shortcut icon" href="<c:url value="resources/release/assets/ico/favicon.ico"/>" />
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<c:url value="resources/release/assets/ico/apple-touch-icon-114-precomposed.png"/>" />
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<c:url value="resources/release/assets/ico/apple-touch-icon-72-precomposed.png"/>" />
    <link rel="apple-touch-icon-precomposed" href="<c:url value="resources/release/assets/ico/apple-touch-icon-57-precomposed.png"/>" />
</head>
<!-- Javascript code -->
...
<body style="cursor:wait">
    <div class="navbar navbar-fixed-top">
        <div id="divNavbarInner" class="navbar-inner">
            <div class="container">
                ...
                <img alt="sipML5" class="brand" src="<c:url value="resources/images/sipml-34x39.png" />
    ...
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/jquery.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-transition.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-alert.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-modal.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-dropdown.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-scrollspy.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-tab.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-tooltip.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-popover.js"/>" ></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-button.js"/>" ></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-collapse.js"/>" ></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-carousel.js"/>" ></script>
    <script type="text/javascript" src="<c:url value="resources/release/assets/js/bootstrap-typeahead.js"/>" ></script>

    <!-- Audios -->
    <audio id="audio_remote" autoplay="autoplay" />
    <audio id="ringtone" loop src="<c:url value="resources/release/sounds/ringtone.wav"/>" />
    <audio id="ringbacktone" loop src="<c:url value="resources/release/sounds/ringbacktone.wav"/>" />
    <audio id="dtmfTone" src="<c:url value="resources/release/sounds/dtmf.wav"/>" />
