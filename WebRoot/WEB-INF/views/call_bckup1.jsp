...
<head>
 ...
 <%-- <script src="<c:url value="resources/scripts/SIPml-api.js"/>" type="text/javascript"> </script>
 --%> 
  <script src="<c:url value="resources/scripts/SIPml.js"/>" type="text/javascript"> </script>
    ...
    function sipRegister() {
        ...
        try {
            ...
            oSipStack = new SIPml.Stack({
                   ...
                   /*               
 					websocket_proxy_url: "ws://14.98.2.251:443",
                    outbound_proxy_url:  "udp://14.98.2.251:5060",
 					ice_servers: null,
...
<body style="cursor:wait">
            ...
            <div class="span4 well">
                ...
                <table style='width: 100%'>
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtDisplayName" value="${userdetail.displayName}"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtPrivateIdentity" value="${userdetail.publicIdentity}"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtPublicIdentity" value="${userdetail.privateIdentity}"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" style="width: 100%; height: 100%" id="txtPassword" value="${userdetail.password}" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtRealm" value="${userdetail.realm}" placeholder="e.g. doubango.org" />
                        </td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-transition.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-alert.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-modal.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-dropdown.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-scrollspy.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-tab.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-tooltip.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-popover.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-button.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-collapse.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-carousel.js"/>"></script>
    <script type="text/javascript" src="<c:url value="resources/assets/js/bootstrap-typeahead.js"/>"></script>

    <!-- Audios -->
    <audio id="audio_remote" autoplay="autoplay" />
    <audio id="ringtone" loop src="<c:url value="resources/sounds/ringtone.wav"/>" />
    <audio id="ringbacktone" loop src="<c:url value="resources/sounds/ringbacktone.wav"/>" />
    <audio id="dtmfTone" src="<c:url value="resources/sounds/dtmf.wav"/>" />
<!-- 
