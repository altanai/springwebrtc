...
public class openLinkDao {
	...
	public static void main(String args[]){
		openLinkBean acc=new openLinkBean();
		openLinkDao dao=new openLinkDao();
		acc=dao.getAccountDetails("sip:hunt@tcs.com");
		System.out.println("SipURI"+acc.getSipuri()+"\nGoogleId="+acc.getGoogleid()+"\nFacebookId="+acc.getFacebookid()+"\nYahooId="+acc.getYahooid());
	}
}
