...
public class makeserverfiles {
	public void WriteServeripFile() {
		try {
           ...
           File serverfilesipml5 = new File("C:/WebRTC_New2/UploadPicsAudioVideo/WebContent/presentation_server_config.txt");
           ...
           //reda to confirm from file 
			...
			File filereadip2 = new File("C:/WebRTC_New2/UploadPicsAudioVideo/WebContent/presentation_server_config.txt");
		...
		//  file exists, rewrite it in pageone folder
	       System.out.println("----------------> writing to pageone local file ");
		    ...
		    File serverfilepageone = new File("C:/WebRTC_New2/UploadPicsAudioVideo/WebContent/presentation_server_config.txt");
           ...
           //reda to confirm from file 
			...
			File filereadip3 = new File("C:/WebRTC_New2/UploadPicsAudioVideo/WebContent/presentation_server_config.txt");
