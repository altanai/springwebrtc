...
<script>
  ...
  FB.init({
    ...
    channelUrl : '//localhost:8080/MetroUiWebrtc/Login.jsp', // Channel File
...
//----------------------------------------fetch info 
  function testAPI() {
      ...
      window.location.href = "http://localhost:8080/MetroUiWebrtc/facebooklogin?userName="+response.name;
    });
  }
</script>
