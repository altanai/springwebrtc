...
<body>
<div class="metro appnavbar" onclick="window.location.href='http://www.google.com'">
        <ul>
            <li>
                <a class="backbutton" href="FirstTile.jsp"  data-bind="click: closeApp">
...
<div id="body">
        ...
        <div class="container metro">
            ...
            <p>
            <a id="signup" class="metro-button">Yes, Sign me up.</a>
            </p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            ...
            <form class="metro-form" id="LoginForm" >
                ...
                <input type="submit" ID="LoginButton" OnClick="LoginButton_Click" class="metro-button" Value="Login" />
            </form>    
        </div>
