    ...
    function sipIM(s_type)
	{
	 ...
	 oConfigMsg = {
		...
		extraContent="[{trxnid}]";
		 ...
		 alert("final mg is"+finalMsg);
		 alert("msgId is"+msgId);
				...
				if (tupleNode) {
					...
					if (check ==="") {
						...
						var i=0;
							...
							xmlHttpRequest.open("POST", "http://localhost:8080/WebRTC_presentation/PresenceServlet?friend1="+infoArray[i][0]+"&friend1status="+infoArray[i][1], true);
							xmlHttpRequest.onreadystatechange=receiveMessageFromServer;
							xmlHttpRequest.send();
							i++;
