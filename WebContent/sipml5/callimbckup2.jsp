...
<body style="cursor:wait" >
    ...
    <div class="container">
		...
		<table>
			<tr>
				<td><button type="button" onclick='sipPublis("publish")' />Publish My Status
							</button></td>
			</tr>
		</table>
		...
		<table>
					<tr>
						<button type="button"
								onclick='sipSubscribe()' />Check Status
							</button>
					</tr>
	    </table>
    ...
    <audio id="dtmfTone" src="sounds/dtmf.wav" />
     ...
     <table>
		<tr>
			<td>Message:<input type="text" id="msg"/> </td>
			<td>Window<textarea id="textArea" disabled="disabled"  rows="10" cols="50"></textarea></td>
			<td>To/From <input type="text" id="uri"/> </td>
			<td> <button id="btnmsg" style="margin: 0; vertical-align:middle; height: 70%;" class="btn btn-primary" onClick="sipIM('message')">Message</button>
            </td>
		</tr>
