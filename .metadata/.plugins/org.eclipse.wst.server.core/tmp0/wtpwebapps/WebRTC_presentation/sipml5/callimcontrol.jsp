...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%@page import="com.tcs.webrtc.screening.utility.Utility"%>
<%@page import="com.tcs.webrtc.screening.bean.ScreenedUserBean"%>
...
<%ArrayList<String> whiteUsers=ScreenedUserBean.getWhiteUsers(); %>
<%ArrayList<String> blackUsers=ScreenedUserBean.getBlackUsers();%>
<% boolean IsDNDActive=new Utility().chkDndValues();
System.out.println("DND Actve ? "+IsDNDActive);%>
...
<script type="text/javascript">
  ...
  // var to;
    ...
    var isAWhiteUser;
    var isABlackUser;
    var isDNDTime=<%=IsDNDActive%>;

    var WhiteUsers = new Array(<%String[] arr=new String[whiteUsers.size()];
       			arr=whiteUsers.toArray(arr);
       			System.out.println("\nTestcalling Page \n");
    ...
    var BlackUsers = new Array(<%String[] arr1=new String[blackUsers.size()];
    	arr=blackUsers.toArray(arr1);
        for(int i = 0; i < arr.length; i++) {  
          out.print("\""+arr1[i]+"\"");  
          if(i+1 < arr1.length) {  
            out.print(",");  
  ...
  //function to chek for scrrend users
     function checkForWhiteUser(caller)
    {
    	isAWhiteUser=false;
    	var callerName=caller.replace("<","");
    	callerName=callerName.replace(">","");
    	for(var i=0;i<WhiteUsers.length;i++)
    	{
    		if(callerName.match(WhiteUsers[i]))
    			{
    			isAWhiteUser=true;
    			}
    	}
    ...
    function checkForBlackUser(caller)
    {	
    	isABlackUser=false;
    	var callerName=caller.replace("<","");
    	callerName=callerName.replace(">","");
    	...
    	{
    		if(callerName.match(BlackUsers[i]))
    		{
    		isABlackUser=true;
    		}
    	}
        ...
        <div class="row-fluid">
          ...
          <tr>
            ...
            <div id="divCallCtrl" class="span7 well" style='display:table-cell; vertical-align:middle' style="background-color:#DDA0DD">
			     ...
			     <table border ="0">
			         <label style="width: 100%;" align="center" id="chatField">
			                </label>
					<tr>   To      : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="uri" placeholder="Enter username eg: John" onblur="chatValidation();" />  </tr>
				
					<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea id="textArea" disabled="disabled"  rows="6" cols="30" ></textarea></td></tr>	
					
					<tr><td>Chat:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="msg" placeholder="Press enter to submit" onKeyPress="enterpressalert(event)"/></td>
								<!-- <td>	<button type="button" class="btn btn-primary" onclick='sipIM("message");'/>chat</button></td> -->			
				                 <!-- <input type="button" name="button" value="Go" onclick="sipIM("message")" class="buttons"/> -->
