	...
	<div class="container">
		<div class="row-fluid">
			<div class="span4 well">
				...
				<img src="http://<%=session.getAttribute("serverip")%>:8080/UploadPicsAudioVideo/CreateUserServlet?id=<%=request.getParameter("privateIdentity")%>%>&action=getProfilePic" width="60" height="60" >
