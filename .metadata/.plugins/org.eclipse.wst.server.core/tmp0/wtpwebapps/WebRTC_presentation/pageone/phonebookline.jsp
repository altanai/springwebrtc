			...
			<div class="primary">
				...
				<ul class="the-team">
					...
					<li class="odd">
						...
						<tr>
							<td>
								<img src="http://<%=session.getAttribute("serverip")%>:8080/UploadPicsAudioVideo/CreateUserServlet?id=<%=list.get(i).getFriendSipURI().toString()%>name=<%=list.get(i).getFriendName().toString() %>&action=getProfilePic" width="60" height="60" >
