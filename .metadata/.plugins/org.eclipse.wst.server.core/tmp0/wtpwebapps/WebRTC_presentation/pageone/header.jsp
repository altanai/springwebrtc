...
<!--             <li><a href="mbook.jsp">Message Book</a>6</li> -->
<!--              <li><a href="#portfolio"></a></li> -->
<!--              <li><a href="#about-us"></a></li> -->
<!--              <li><a href="home.jsp#styles">Offline Messages</a></li>
                <li><a href="home.jsp#contact">Contact Us</a></li> --><!-- 
           <li>
			<a href="#" title="this is a tooltip">Notifications</a>
			<ul>
				<li><a href="#"><table><tr><td><img width="60" height="60" src="images/cred.png"/></td><td>Alice shared a location from your interests</td></tr></table></a></li>
				<li><a href="#"><table><tr><td><img width="60" height="60" src="images/alice.png"/></td><td>You have a missed call from alice</td></tr></table></a></li>
			</ul>
